...
<style>
    ...
    /* Menggunakan strikethrough jika status == 1 */
    .list-group-item.status-1 .content-tugas {
        text-decoration: line-through;
    }

    /* Mengatur scroll jika lebih dari 5 tugas */
    .list-group.scrollable {
        max-height: 250px; /* Sesuaikan dengan tinggi maksimal yang diinginkan */
        overflow-y: auto;
    }
</style>
        ...
        <div class="col-lg-6">
            <div class="cards cards-stats mb-4 mb-xl-0">
                <div class="cards-body">
                    <div class="row">
                        <div class="col">
                            <h5 class="cards-title">Daftar Tugas Hari Ini</h5>
                            <ul class="list-group {{ count($tugas) > 5 ? 'scrollable' : '' }}">
                                @foreach($tugas as $tugasItem)
                                <li class="list-group-item {{ $tugasItem->status == 1 ? 'status-1' : '' }}">
